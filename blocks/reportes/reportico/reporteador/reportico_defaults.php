    ...
    function reportico_defaults($reportico)
    {
            ...
            */
            ...
            {   
                ...
                $reportico->create_page_footer("F1", 2, "Impreso por: ".$user." Sistema de Gestión de concursos - darwin {STYLE border-width: 1 0 0 0; margin: 40 0 0 0; font-size: 8; text-align: left; font-style: italic; }" );
